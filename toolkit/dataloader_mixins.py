...
class LatentCachingMixin:
            ...
            try:
                ...
                while pending:
                    ...
                    if needs_encode and not did_move:
                        ...
                        did_move = True
                    ok = self._cache_one_latent(file_item, latent_path, cached_state_dict, needs_encode, to_disk, to_memory)
                    if ok:
    ...
    def _cache_one_latent(
        ...
        """Encodes (or loads from cache) one item. Returns False if the item
        failed and was skipped, True otherwise."""
